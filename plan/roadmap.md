...
- **N11h** (depends on: N11g): Separate graph-growth horizon from view scope, land additive stable embedding under growth, implement camera-view-driven graph expansion plus optional URL path-pre-expansion without requiring click-to-expand interaction, and introduce compressed residency sufficient for large visible low-detail subsets.
- **N12** (depends on: N10c, N11, N11h): Add anchored or focus-preset entrypoints over one live expandable JS-generated object instance, with optional asset-backed anchors refining but not replacing runtime generation, while preserving the same focus-level and render-budget semantics across entrypoints.
...
- **N14** (depends on: N07, N08a, N10c, N11, N11h, N12, N13): Execute operational acceptance suite and budgets over the live expandable JS-generated runtime plus any optional project-owned assets, including visible-node scale, render-demand enumeration, and memory envelopes.
