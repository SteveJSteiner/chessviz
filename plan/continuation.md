...
- Known transpositions render as multiple occurrences plus a visible relation sourced from the repeated-state query surface.
- The transposition relation remains legible without collapsing occurrence identity or fracturing the shared regime contract.
