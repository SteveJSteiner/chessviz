...
- Move-interaction departure rules are derived from the existing occurrence transition and move-fact surfaces without changing occurrence identity, repeated-state relations, runtime neighborhood query semantics, or coarse embedding coordinates.
...
- The departure-rule seam remains separate from later multiscale carrier generation, camera grammar, and anchored entrypoint logic.
