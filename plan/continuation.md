...
- Recorded human review of rendered structure-zoom and refinement-step views confirms the object is visually readable and that coarse move-family readings survive distance; automated checks are supporting evidence only.
...
- N10 may span multiple visible-change commits before settlement; commit cadence alone does not imply node completion.
