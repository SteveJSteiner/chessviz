...
- **D2. One represented structure** — The viewer presents one continuous represented chess structure rather than separate diagrams, presets, or review artifacts.
...
- **D5. Camera motion drives reveal** — Moving through the represented structure is allowed to trigger graph growth and detail reveal directly.
...
- **D8. Purge-first simplification** — Anchored entrypoints, artifact-backed runtime paths, transposition overlays, and review-document generators are removed unless they directly serve detached traversal through the represented structure.
